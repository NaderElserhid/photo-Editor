...
var TabContainer = React.memo(function (_a) {
    ...
    var _l = React.useState([]), header = _l[0], setHeader = _l[1];
    var _m = React.useState(activeIndex), activeTab = _m[0], setActiveTab = _m[1];
    ...
    var tabsItems = children instanceof Array ? children : [children];
    return React__default["default"].createElement("div", { ref: tabContainerRef, className: "tab-pp" },
        React__default["default"].createElement("div", { className: "header", style: { backgroundColor: backgroundColor, borderBottom: borderLine ? '1px solid #323232' : 'undet' } }, header.map(function (el, index) { return (React__default["default"].createElement("button", { onClick: function () {
                if (el.disabled)
                    return;
                setActiveTab(index);
            }, key: el.label, style: {
            ...
            " ",
            el.label,
            indicatorStyle === 'bottomLine' && (React__default["default"].createElement("div", { style: { backgroundColor: color } })))); })),
        React__default["default"].createElement("div", { className: "body" }, tabsItems.map(function (tabEl, index) {
            if (index < activeTab) {
...
var TabItem = React.memo(function (_a) {
    ...
    return React__default["default"].createElement("div", { style: { padding: '1rem 0.5rem' } }, children);
});
...
var Input = React.memo(function (props) {
    ...
    var _b = React.useState(props.value), state = _b[0], setState = _b[1];
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        onInputChangedEnd && React__default["default"].createElement("input", __assign({}, restProps, { className: restProps === null || restProps === void 0 ? void 0 : restProps.className, style: restProps.style, value: props.value, onChange: changeValue, onBlur: function (e) { onInputChangedEnd(e.target.value); }, onKeyDown: function (e) {
                if (e.key == 'Enter')
                    onInputChangedEnd(state);
            } })),
        !onInputChangedEnd && React__default["default"].createElement("input", __assign({}, restProps, { className: restProps === null || restProps === void 0 ? void 0 : restProps.className, style: restProps.style, value: props.value, onChange: changeValue }))));
});
...
var BasicFilter = React.memo(function (_a) {
    ...
    return React__default["default"].createElement("div", null,
        React__default["default"].createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            React__default["default"].createElement("p", { className: "item-panel" }, labels['Contrast']),
            React__default["default"].createElement("p", { className: "item-panel" }, (+state.contrast).toFixed(2))),
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { className: "input-range", onChangedDelayed: onUpdateContrast, delayMs: 100, onChangedValue: function (value) { setState(__assign(__assign({}, state), { contrast: value })); }, style: {
                    maxWidth: '100%', width: '100%', color: color
                }, type: "range", min: "0", max: "5", step: "0.01", value: state.contrast })),
        React__default["default"].createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            React__default["default"].createElement("p", { className: "item-panel" }, labels['Brightness']),
            React__default["default"].createElement("p", { className: "item-panel" }, (+state.brightness).toFixed(2))),
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { className: "input-range", onChangedDelayed: onUpdateBrightness, onChangedValue: function (value) { setState(__assign(__assign({}, state), { brightness: value })); }, style: {
                    maxWidth: '100%', width: '100%', color: color
                }, type: "range", min: "0", max: "5", step: "0.01", value: state.brightness })),
        React__default["default"].createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            React__default["default"].createElement("p", { className: "item-panel" }, labels['Grayscale']),
            React__default["default"].createElement("p", { className: "item-panel" }, (+state.grayscale).toFixed(2))),
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { className: "input-range", onChangedDelayed: onUpdateGrayscale, onChangedValue: function (value) { setState(__assign(__assign({}, state), { grayscale: value })); }, style: {
                    maxWidth: '100%', width: '100%', color: color
                }, type: "range", min: "0", max: "5", step: "0.01", value: state.grayscale })),
        React__default["default"].createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            React__default["default"].createElement("p", { className: "item-panel" }, labels['Saturate']),
            React__default["default"].createElement("p", { className: "item-panel" }, (+state.saturate).toFixed(2))),
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { className: "input-range", onChangedDelayed: onUpdateSaturate, onChangedValue: function (value) { setState(__assign(__assign({}, state), { saturate: value })); }, style: {
                    maxWidth: '100%', width: '100%', color: color
                }, type: "range", min: "0", max: "5", step: "0.01", value: state.saturate })),
        React__default["default"].createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            React__default["default"].createElement("p", { className: "item-panel" }, labels['Sepia']),
            React__default["default"].createElement("p", { className: "item-panel" }, (+state.sepia).toFixed(2))),
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { className: "input-range", onChangedDelayed: onUpdateSepia, onChangedValue: function (value) { setState(__assign(__assign({}, state), { sepia: value })); }, style: {
                    maxWidth: '100%', width: '100%', color: color
                }, type: "range", min: "0", max: "5", step: "0.01", value: state.sepia })),
        React__default["default"].createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
            React__default["default"].createElement("p", { className: "item-panel" }, labels['Blur']),
            React__default["default"].createElement("p", { className: "item-panel" }, (+state.blur).toFixed(2))),
        React__default["default"].createElement("div", { className: 'flex-row-start' },
            React__default["default"].createElement(Input, { className: "input-range", onChangedDelayed: onUpdateBlur, onChangedValue: function (value) { setState(__assign(__assign({}, state), { blur: value })); }, style: {
                    maxWidth: '100%', width: '100%', color: color
...
var CropprWrapper = React.memo(function (_a) {
    var src = _a.src, size = _a.size, croppUpdate = _a.croppUpdate;
    var _b = React.useState(), imageSrc = _b[0], setImageSrc = _b[1];
    var _c = React.useState({ width: 150, height: 150 }), croppSize = _c[0], setCroppSize = _c[1];
    ...
    return React__default["default"].createElement("div", { className: 'CropprWrapper' },
        React__default["default"].createElement("img", { ref: mount, src: imageSrc, id: "croppr" }));
});
...
var EditImage = React.memo(function (_a) {
    var _b;
    ...
    var _h = React.useState(initialState), state = _h[0], setState = _h[1];
    var _j = React.useState(''), imageSrc = _j[0], setImageSrc = _j[1];
    var _k = React.useState(false), showCrop = _k[0], setShowCrop = _k[1];
    var _l = React.useState({
        width: 150,
        height: 150
    }), croppSize = _l[0], setCroppSize = _l[1];
    var _m = React.useState(), croppState = _m[0], setCroppState = _m[1];
    ...
    return (React__default["default"].createElement("div", { className: "EditImage ".concat(dark ? "dark" : "") },
        React__default["default"].createElement("div", { id: 'popup', className: 'popup' },
            React__default["default"].createElement("div", { style: {
                ...
                React__default["default"].createElement("button", { className: 'icon-btn', onClick: function () {
                        onCloseEditPanel(false);
                    } },
                    React__default["default"].createElement("span", { className: 'material-icons' }, "clear"))),
            React__default["default"].createElement("div", { className: 'image-container' },
                React__default["default"].createElement("div", { className: 'image-holder-full' },
                    !showCrop && React__default["default"].createElement("img", { id: 'image-full', src: imageSrc }),
                    showCrop && (React__default["default"].createElement(CropprWrapper, { src: imageSrc, size: croppSize, croppUpdate: onCroppUpdate }))),
                React__default["default"].createElement("div", { className: 'control-panel' },
                    React__default["default"].createElement(TabContainer, { lazy: true, borderLine: true },
                        React__default["default"].createElement(TabItem, { name: labels['Basic'] },
                            (!isMobile.current || (isMobile.current && !showCrop)) && (React__default["default"].createElement(React__default["default"].Fragment, null,
                                React__default["default"].createElement("div", { style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
                                    React__default["default"].createElement("p", { className: 'item-panel' }, labels['Quality']),
                                    React__default["default"].createElement("p", { className: 'item-panel' }, state.quality + '%')),
                                React__default["default"].createElement("div", { className: 'flex-row-start' },
                                    React__default["default"].createElement(Input, { readOnly: showCrop, disabled: showCrop, className: 'input-range', onChangedDelayed: onUpdateQuality, onChangedValue: function (value) {
                                ...
                                React__default["default"].createElement("div", { className: 'item-panel', style: { display: 'flex', width: '100%', justifyContent: 'space-between' } },
                                    labels['Max dimensions'],
                                    React__default["default"].createElement("div", { style: { display: 'flex', alignItems: 'center', gap: ".5rem" } },
                                        React__default["default"].createElement("input", { disabled: showCrop, readOnly: showCrop, type: 'checkbox', checked: state.maintainAspectRatio, onChange: function (e) {
                                                return setState(__assign(__assign({}, state), { maintainAspectRatio: e.target.checked }));
                                            }, style: { color: color } }),
                                        React__default["default"].createElement("span", { className: 'caption' }, labels['aspect-ratio']))),
                                React__default["default"].createElement("div", { className: 'flex-row-start', style: { marginTop: '10px', justifyContent: 'space-between' } },
                                    React__default["default"].createElement("div", { className: 'form-field', style: { maxWidth: '48%', width: '48%' } },
                                        React__default["default"].createElement("label", null, labels['max-width(px)']),
                                        React__default["default"].createElement(Input, { readOnly: showCrop, disabled: showCrop, placeholder: labels['max-width(px)'], value: state.maxWidth, onChangedValue: function (value) {
                                    ...
                                    React__default["default"].createElement("div", { className: 'form-field', style: { maxWidth: '48%', width: '48%' } },
                                        React__default["default"].createElement("label", null, labels['max-height(px)']),
                                        React__default["default"].createElement(Input, { readOnly: showCrop, disabled: showCrop, placeholder: labels['max-height(px)'], value: state.maxHeight, onChangedValue: function (value) {
                                                return setState(__assign(__assign({}, state), { maxHeight: value }));
                                            }, type: 'number', min: 0, max: 2000, onInputChangedEnd: function (value) {
                                                onChangeSize(value, true);
                                            } }))),
                                React__default["default"].createElement("p", { className: 'item-panel' }, labels['Format']),
                                React__default["default"].createElement("div", { className: 'flex-row-start', style: { marginTop: '10px', justifyContent: 'space-between' } },
                                    React__default["default"].createElement("div", { className: 'form-field', style: { width: '100%' } },
                                        React__default["default"].createElement("select", { disabled: showCrop, value: state.format, onChange: onChangeFormat }, allFormats.map(function (formatItem, index) { return (React__default["default"].createElement("option", { key: index, value: formatItem }, formatItem)); })))))),
                            React__default["default"].createElement("div", { className: 'flex-row-start', style: { marginTop: '5px', justifyContent: 'space-between' } },
                                React__default["default"].createElement("span", { style: { display: 'flex', alignItems: 'center', gap: ".5rem" } },
                                    React__default["default"].createElement("input", { type: 'checkbox', onChange: function (e) {
                                            setShowCrop(e.target.checked);
                                        }, checked: showCrop, style: { color: color, marginBottom: '3px' } }),
                                    React__default["default"].createElement("span", { className: 'item-panel', style: { marginLeft: '4px' } }, labels['Crop']))),
                            showCrop && (React__default["default"].createElement(React__default["default"].Fragment, null,
                                React__default["default"].createElement("div", { className: 'flex-row-start', style: { marginTop: '10px', justifyContent: 'space-between' } },
                                    React__default["default"].createElement("div", { className: 'form-field', style: { maxWidth: '48%', width: '48%' } },
                                        React__default["default"].createElement("label", null, labels['width(px)']),
                                        React__default["default"].createElement(Input, { type: 'number', min: 0, value: state.cropWidth, onChangedValue: function (value) {
                                    ...
                                    React__default["default"].createElement("div", { className: 'form-field', style: { maxWidth: '48%', width: '48%' } },
                                        React__default["default"].createElement("label", null, labels['height(px)']),
                                        React__default["default"].createElement(Input, { type: 'number', min: 0, value: state.cropHeight, onInputChangedEnd: function (value) {
                                ...
                                React__default["default"].createElement("p", { style: { marginBottom: '4px !important' } },
                                    React__default["default"].createElement("button", { title: labels['Confirm Crop'], className: 'icon-btn', onClick: onCrop },
                                        React__default["default"].createElement("span", { className: 'material-icons' }, " crop "),
                                        React__default["default"].createElement("span", { style: { color: '#fff', marginLeft: 8 } }, labels['Confirm Crop'])))))),
                        React__default["default"].createElement(TabItem, { disabled: showCrop, name: labels['Filters'] },
                            React__default["default"].createElement(BasicFilter, { color: color, labels: labels, initialState: state.basicFilters, changeFilter: onChangeFilters }))),
                    React__default["default"].createElement("button", { title: labels['Undo'], disabled: state.arrayCopiedImages.length <= 1, style: (_b = { position: 'absolute' }, _b[rtl ? 'left' : 'right'] = '10px', _b.top = '30px', _b), className: 'icon-btn', onClick: onRestore },
                        React__default["default"].createElement("span", { className: 'material-icons' }, " refresh ")),
                    React__default["default"].createElement("div", { className: 'flex-row-start', style: { marginTop: '10px', justifyContent: 'space-between', alignItems: 'center' } },
                        React__default["default"].createElement("button", { className: 'save-btn', disabled: showCrop, onClick: function () {
                                onCloseEditPanel(true);
                            } }, labels['Save']),
                        sizeImage && (React__default["default"].createElement("p", { className: 'caption image-caption', style: {
...
var ReactImagePickerEditor = React.memo(function (_a) {
    ...
    var _f = React.useState(__assign({}, initialState)), state = _f[0], setState = _f[1];
    var _g = React.useState(''), imageSrc = _g[0], setImageSrc = _g[1];
    var _h = React.useState(false), loadImage = _h[0], setLoadImage = _h[1];
    var _j = React.useState(false), showEditPanel = _j[0], setShowEditPanel = _j[1];
    var _k = React.useState(labelEn), labels = _k[0], setLabels = _k[1];
    var _l = React.useState(initialConfig), configuration = _l[0], setConfiguration = _l[1];
    ...
    var imageName = React.useRef('download');
    React.useRef(false);
    React.useEffect(function () {
    ...
    return (React__default["default"].createElement("div", { className: "ReactImagePickerEditor ".concat(config.darkMode ? "dark" : "") },
        !loadImage && (React__default["default"].createElement("div", { className: 'place-image' },
            React__default["default"].createElement("div", { className: 'image-holder', style: {
                    width: configuration.width,
                    height: configuration.height,
                    borderRadius: configuration.borderRadius,
                    aspectRatio: configuration.aspectRatio + ''
                } },
                React__default["default"].createElement("button", { title: labels['Upload a image'], className: 'icon-btn image-upload-btn', onClick: onUpload },
                    React__default["default"].createElement("span", { className: 'material-icons' }, "add_a_photo")),
                React__default["default"].createElement("input", { ref: imagePicker, type: 'file', style: { display: 'none' }, id: 'filePicker-' + uuidFilePicker, onChange: handleFileSelect })))),
        loadImage && (React__default["default"].createElement("div", { className: 'place-image' },
            React__default["default"].createElement("div", { className: 'image-holder-loaded', style: {
                    width: configuration.width,
                    height: configuration.height,
                    borderRadius: configuration.borderRadius,
                    aspectRatio: configuration.aspectRatio + ''
                } },
                React__default["default"].createElement("img", { src: imageSrc, alt: 'image-loaded', style: {
                        borderRadius: configuration.borderRadius,
                        objectFit: configuration.objectFit
                    } }),
                React__default["default"].createElement("div", { className: 'curtain', onClick: onUpload },
                    React__default["default"].createElement("button", { title: labels['Upload a image'] },
                        React__default["default"].createElement("span", { className: 'material-icons' }, "add_a_photo"))),
                React__default["default"].createElement("input", { ref: imagePicker, type: 'file', style: { display: 'none' }, id: 'filePicker-' + uuidFilePicker, onChange: handleFileSelect })),
            sizeImage && (React__default["default"].createElement("p", { className: 'caption image-caption', style: {
                    color: sizeImage > 120 ? '#f44336' : 'unset',
            ...
            React__default["default"].createElement("div", { style: {
                ...
                !configuration.hideAddBtn && (React__default["default"].createElement("button", { className: 'icon-btn', id: 'upload-img', title: labels['Upload a image'], onClick: onUpload },
                    React__default["default"].createElement("span", { className: 'material-icons' }, "add_a_photo"))),
                !configuration.hideEditBtn && (React__default["default"].createElement("button", { className: 'icon-btn', id: 'edit-img', title: labels['Open the editor panel'], onClick: onOpenEditPanel },
                    React__default["default"].createElement("span", { className: 'material-icons' }, "edit"))),
                !configuration.hideDownloadBtn && (React__default["default"].createElement("a", { id: 'download-img', title: labels['Download the image'], href: imageSrc, download: imageName.current },
                    React__default["default"].createElement("span", { className: 'material-icons' }, "cloud_download"))),
                !configuration.hideDeleteBtn && (React__default["default"].createElement("button", { className: 'icon-btn', id: 'delete-img', title: labels['Remove'], onClick: function () { return onRemove(); } },
                    React__default["default"].createElement("span", { className: 'material-icons' }, "delete")))))),
        showEditPanel && (React__default["default"].createElement(EditImage, { saveUpdates: onCloseEditPanel, labels: labels, color: color, image: imageSrc, initialState: state, rtl: config.rtl || false, dark: config.darkMode || false }))));
});
